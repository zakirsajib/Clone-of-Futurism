...
<article id="post-<?php the_ID(); ?>" <?php post_class('post listing new-listing'); ?>>
	...
	<div class="post-image">
        <?php if(has_post_thumbnail() ) : ?>
  		...
  		<?php else:?>
  			<a class="post-img " href="<?php the_permalink()?>" data-original="http://placehold.it/675x600" style="background-color: #eee;"  title="<?php the_title()?>" data-wpex-post-id="<?php the_ID(); ?>"></a>
  		<?php endif;?>
    </div>
